...
abstract class $PokemonStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, MError? error});
}
...
class _$PokemonStateImpl extends _PokemonState {
  const _$PokemonStateImpl({this.isLoading = false, this.error = null})
    : super._();
  ...
  @override
  String toString() {
    return 'PokemonState(isLoading: $isLoading, error: $error)';
  }
...
abstract class _PokemonState extends PokemonState {
  const factory _PokemonState({final bool isLoading, final MError? error}) =
      _$PokemonStateImpl;
